...
<body>
    ...
    <section id="main" style="margin-top:100px;">
     ...
     <div class="container">
       ...
       <div class="form-group">
      <label for="bn">Your Branch Name</label>
			<input type="text" class="form-control" name="fname" placeholder="Branch" required>
			</div><br>
			<div class="form-group">
			...
			<div class="form-group">
            <label for="">Your Father's Name </label>
			<input type="text" class="form-control" name="faname" placeholder="Your Father's Name " required>
			</div><br>
			<div class="form-group">
            <label for="">Your Mother's Name </label>
			<input type="text" class="form-control" name="mname" placeholder="Your Mother's Name " required>
			</div><br>
			<div class="form-group">
      ...
      <label for="">Upload Your Picture</label>
       ...
       <footer class="foot">
            <center><p>Copyright &copy;2018<br>Developed By <a href="http://fb.com/shiva.kandel">shiva kandel</a></p></center>
        </footer>
